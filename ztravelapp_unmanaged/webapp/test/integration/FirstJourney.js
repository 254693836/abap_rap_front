sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheTravelList.onTable().iCheckColumns(4, {"TravelID":{"header":"Travel ID"},"AgencyID":{"header":"Agency ID"},"CustomerID":{"header":"Customer ID"},"OverallStatus":{"header":"Overall Status"}});
